        ...
        child: Row(
          ...
          children: [
            ...
            ConstrainedBox(
              ...
              child: Text(compactPlayerName(name, maxLen: 16),
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis,
                  style: TextStyle(
                      color: c.text,
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Flexible(
                        // Compact long names ("Niroshan Dickwella" -> "N.
                        // Dickwella") so the role/captain badges never clip the
                        // surname mid-word.
                        child: Text(compactPlayerName(name, maxLen: 15),
                            maxLines: 1,
                            overflow: TextOverflow.ellipsis,
                            style: TextStyle(
                                color: c.text,
