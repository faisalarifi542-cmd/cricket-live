...
class SAsset {
  ...
  static const detailHeroBg = '$_bg/series_detail_hero_bg.webp';
  static const matchCardBg = '$_bg/series_match_card_bg.webp';
  static const listCardBg = '$_bg/series_list_card_bg.webp';
  static const overviewPanelBg = '$_bg/series_overview_panel_bg.webp';
  static const statsTableBg = '$_bg/series_stats_table_bg.webp';
  ...
  static const vsLightStreak = '$_fx/vs_light_streak.webp';
  ...
  static const homeStadiumBackdrop =
      '$_home/futuristic_stadium_ui_backdrop.webp';
  ...
  static String venueFor(String venue) {
    ...
    if (v.contains('indore') || v.contains('holkar')) {
      return '$_venue/venue_indore.webp';
    }
    if (v.contains('delhi') || v.contains('jaitley') || v.contains('kotla')) {
      return '$_venue/venue_delhi.webp';
    }
    if (v.contains('mumbai') ||
        v.contains('wankhede') ||
        v.contains('brabourne')) {
      return '$_venue/venue_mumbai.webp';
    }
    if (v.contains('bengaluru') ||
        v.contains('bangalore') ||
        v.contains('chinnaswamy')) {
      return '$_venue/venue_bengaluru.webp';
    }
    return '$_venue/venue_generic.webp';
  }
}

// ---------------------------------------------------------------------------
// Soft radial glow orb (floodlight / accent) — now shared from components.dart.
// ---------------------------------------------------------------------------
...
class PremiumGlassPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final c = context.cric;
    // Light mode: opaque white card so the dark stadium backdrop / bg texture
    // never bleeds through (the #1 "light looks dark" bug). Dark mode keeps the
    // original translucent glass look.
...
class PremiumTeamColumn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final showName = showFullName &&
        displayName.isNotEmpty &&
        displayName.toUpperCase() != code.toUpperCase();
    return Column(
      mainAxisSize: MainAxisSize.min,
      children: [
        PremiumTeamLogo(
...
class PremiumVsBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final c = context.cric;
    // Light mode: no cyan halo (rule 9). The glow layers below are scaled by
    // `glow` (0 in light) and the pill paints a clean blue→cyan gradient.
        ...
        children: [
            ...
            child: DecoratedBox(
              decoration: BoxDecoration(
                ...
                gradient: RadialGradient(
                  colors: [
                    c.cyan.withValues(alpha: 0.34 * glow),
                    c.cyan.withValues(alpha: 0.12 * glow),
                    Colors.transparent,
                  ],
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(999),
                color: c.cyan.withValues(alpha: 0.20 * glow),
                boxShadow: [
                  BoxShadow(
                    color: c.cyan.withValues(alpha: 0.42 * glow),
                    blurRadius: 20,
                    spreadRadius: 5,
                  ),
                  BoxShadow(
                    color: c.cyan.withValues(alpha: 0.18 * glow),
                    blurRadius: 34,
                    spreadRadius: 10,
                  ),
                ],
          ...
          Transform.rotate(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: c.cyan.withValues(alpha: 0.35 * glow),
                    blurRadius: 14,
                    spreadRadius: 1,
                  ),
                ],
...
class _VsBadgePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (fillGradient != null) {
      fillPaint.shader =
          fillGradient!.createShader(Offset.zero & size);
    } else {
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                gradient: sel
                    ...
                    : null,
                color: sel ? null : (c.isDark ? c.card.withValues(alpha: .4) : c.card),
        ...
        children: [
          const Positioned.fill(
            child: StadiumImage(
              ...
              hero: true,
              fit: BoxFit.cover,
              remoteKey: 'series_empty_state_bg',
            ),
          ),
          Positioned.fill(
            child: DecoratedBox(
