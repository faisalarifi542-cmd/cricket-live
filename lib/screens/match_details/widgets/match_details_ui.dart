...
class MDAsset {
  ...
  static const heroBg = '$_bg/stadium_score_header_bg.png';
  static const cardBg = '$_bg/stadium_card_bg.png';
  static const glassBg = '$_bg/glass_panel_bg.png';

  static const teamRing = '$_ov/team_logo_ring.png';
  static const vsGlow = '$_ov/vs_under_glow.png';
  static const vsStreak = '$_ov/vs_light_streak.png';
  static const topEdgeGlow = '$_ov/cyan_top_edge_glow.png';

  static const vsBadge = '$_badge/vs_badge_premium.png';

  // Premium section / tab icons (line-art PNGs sized for this module).
  static const icBack = '$_icon/back_arrow.png';
  static const icFilter = '$_icon/filter_sliders.png';
  static const icUpdated = '$_icon/updated.png';
  static const icRefresh = '$_icon/refresh.png';
  static const icVenue = '$_icon/venue.png';
  static const icLocationPin = '$_icon/location_pin.png';
  static const icCurrentBatters = '$_icon/current_batters.png';
  static const icCurrentBowler = '$_icon/current_bowler.png';
  static const icPartnership = '$_icon/partnership.png';
  static const icLastWicket = '$_icon/last_wicket.png';
  static const icRecentOver = '$_icon/recent_over.png';
  static const icRunRate = '$_icon/run_rate.png';
  static const icViewMore = '$_icon/view_more.png';
  static const icExpandDown = '$_icon/expand_down.png';
  static const icBatting = '$_icon/batting.png';
  static const icBowling = '$_icon/bowling.png';
  static const icFallWickets = '$_icon/fall_wickets.png';

  static const tabInfo = '$_icon/tab_info.png';
  static const tabLive = '$_icon/tab_live.png';
  static const tabScorecard = '$_icon/tab_scorecard.png';
  static const tabSquad = '$_icon/tab_squad.png';
  static const tabCommentary = '$_icon/tab_commentary.png';
  static const tabOvers = '$_icon/tab_overs.png';

  static String ball(String label, {bool wicket = false}) {
    if (wicket) return '$_balls/ball_wicket.png';
    switch (label.trim().toLowerCase()) {
      case '0':
      case '.':
      case 'dot':
        return '$_balls/ball_dot.png';
      case '1':
        return '$_balls/ball_1.png';
      case '2':
        return '$_balls/ball_2.png';
      case '3':
        return '$_balls/ball_3.png';
      case '4':
        return '$_balls/ball_4.png';
      case '6':
        return '$_balls/ball_6.png';
      case 'w':
        return '$_balls/ball_wicket.png';
      default:
        return '$_balls/ball_dot.png';
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final body = Container(
      ...
      decoration: BoxDecoration(
        ...
        color: c.card.withValues(alpha: .6),
        border:
        ...
        children: [
            ...
            child: DecoratedBox(
              decoration: BoxDecoration(
                ...
                gradient: RadialGradient(
                  colors: [
                    c.cyan.withValues(alpha: 0.45 * intensity),
                    c.cyan.withValues(alpha: 0.16 * intensity),
                    Colors.transparent,
                  ],
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(999),
                color: c.cyan.withValues(alpha: 0.26 * intensity),
                boxShadow: [
                  BoxShadow(
                    color: c.cyan.withValues(alpha: 0.55 * intensity),
                    blurRadius: 26,
                    spreadRadius: 7,
                  ),
                  BoxShadow(
                    color: c.cyan.withValues(alpha: 0.24 * intensity),
                    blurRadius: 44,
                    spreadRadius: 14,
                  ),
                ],
...
class _VsPainter extends CustomPainter {
  _VsPainter({required this.border, required this.fill, required this.glow});
  ...
  bool shouldRepaint(covariant _VsPainter old) =>
      old.border != border || old.fill != fill || old.glow != glow;
}
...
class MDTeamScoreBlock extends StatelessWidget {
  ...
  final String short;
  final String? logo;
  final String score; // raw, may include "(... ov)"
  final Color accent;
  ...
  Widget build(BuildContext context) {
    ...
    final (main, overs) = _splitScore(score, code);
    return Column(
      mainAxisSize: MainAxisSize.min,
      children: [
        Container(
  ...
  static (String, String) _splitScore(String score, String code) {
    var s = score.trim();
    if (s.isEmpty) return ('', '');
    if (code.isNotEmpty && s.toUpperCase().startsWith(code.toUpperCase())) {
      s = s.substring(code.length).trim();
    }
    s = s.replaceAll('OV', 'ov').replaceAll('Ov', 'ov');
    final open = s.indexOf('(');
    if (open > 0) {
      return (s.substring(0, open).trim(), s.substring(open).trim());
    }
    return (s, '');
  }
}
  ...
  Widget build(BuildContext context) {
    ...
    final (statusLabel, statusColor) = isLive
        ...
        : isFinished
            ? ('RESULT', c.success)
            : ('UPCOMING', c.cyan);
    final statusText = m.statusText.isNotEmpty
        ? m.statusText
                  ...
                  children: [
                    Expanded(
                      child: MDTeamScoreBlock(
                        ...
                        short: m.teamAShort,
                        logo: m.teamALogo,
                        score: (isLive || isFinished) ? m.teamAScoreText : '',
                        accent: c.cyan,
                        logoSize: logoSize,
                      ),
                    ),
                    ...
                    Expanded(
                      child: MDTeamScoreBlock(
                        ...
                        short: m.teamBShort,
                        logo: m.teamBLogo,
                        score: (isLive || isFinished) ? m.teamBScoreText : '',
                        accent: c.warning,
                        logoSize: logoSize,
                      ),
                    ),
...
class MatchDetailsTopBar extends StatelessWidget {
  const MatchDetailsTopBar({super.key, required this.onBack, this.onFilter});
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border:
                  Border.all(color: c.cyan.withValues(alpha: .75), width: 1.3),
              boxShadow: [
                BoxShadow(
            ...
            alignment: Alignment.center,
            child: const MDIcon(MDAsset.icFilter,
                fallback: Icons.tune_rounded, size: 19),
          ),
        ),
      ],
    );
