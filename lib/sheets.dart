    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          _section('Match Type', [
            for (final t in ['T20I', 'ODI', 'Test', 'League'])
              PillChip(t,
          ...
          _section('Status', [
            for (final s in ['Live', 'Upcoming', 'Finished'])
              PillChip(s,
                  selected: statuses.contains(s),
                  onTap: () => setState(() => statuses.contains(s)
                      ? statuses.remove(s)
                      : statuses.add(s)))
          ]),
          const SizedBox(height: 16),
        ...
        children: [
          ...
          SizedBox(
              ...
              child: GradientButton(
                  label: 'Done', onTap: () => Navigator.pop(context))),
        ],
      );
    }
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 6),
        Text('Get notified before the match starts.',
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          color: selected == i ? c.cyan : c.border, width: 2),
                      color: selected == i
                    ...
                    child: selected == i
                        ? Icon(Icons.check_rounded, color: c.cyan, size: 16)
                        : null,
                  ),
      ...
      children: [
        Text('Add to Calendar',
            style: TextStyle(
                color: c.text, fontSize: 22, fontWeight: FontWeight.w900)),
        const SizedBox(height: 6),
        Text('Pick which matches you want synced to your calendar.',
            style: TextStyle(color: c.muted)),
        const SizedBox(height: 16),
              ...
              child: Row(
                children: [
                  CircleAvatar(
                      ...
                      child: Icon(option.$2, color: c.cyan)),
                  const SizedBox(width: 14),
                  Expanded(
                      child: Text(option.$1,
                          style: TextStyle(
